...
<body id="vereadores" class="view">
  <section class="container" id="conteudo">
    ...
    <table id="tablePautas" class="display col-xs-12 col-sm-12 dataTable no-footer" style="width:100%">
          <thead>
            <tr>
          ...
          <tbody>
            <?php foreach ($resultado_pautas as $key => $value) { ?>
              <tr>
                <td>
                  <a href="documentos/arquivos_pdf/pautas/<?= $value['file'] ?>" target="_blank" class="link-table clearfix">
                    <strong class="vereador-nome"> PAUTAS - <?= $value['title'] ?> </strong>
