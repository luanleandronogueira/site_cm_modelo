...
$listar_agenda = $db->prepare("SELECT * FROM `agenda_oficial`");
  ...
  <div class="card shadow mb-4 mt-4">
    <div class="card-header py-3">
      <div class="row align-items-center">
        <div class="col">
          <h6 class="m-0 font-weight-bold text-primary">Agendas Oficiais</h6>
        </div>
        <div class="col text-right">
          <a href="cadastrar_agenda" class="btn btn-primary btn-sm">Adicionar nova agenda</a>
        </div>
      </div>
    </div>
    <div class="card-body">
          ...
          <tbody class="text-center">
            <?php foreach ($resultado_agenda as $key => $value) { ?>
              <tr>
                ...
                <td style="max-width: 190px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap"><?= $value['description'] ?></td>
